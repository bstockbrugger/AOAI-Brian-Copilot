...
# This uses Azure OpenAI service and the GPT 4 model
...
openai.api_base = "https://blstech-azureopenai-gpt4.openai.azure.com/" # Your Azure OpenAI API endpoint
openai.api_version = "2023-07-01-preview"
deployment_name = "GPT4-32K" # Your Azure OpenAI deployment name
...
secret_name = "AzureOpenAI-GPT4-API" # Your Key Vault secret name
...
print('The completion is using GPT4-32K mode in Azure OpenAI API service') 
while True:
